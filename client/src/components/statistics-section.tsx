...
export default function StatisticsSection() {
  return (
    <section className="py-20 bg-gradient-to-br from-primary to-secondary" data-testid="section-statistics">
      <div className="container mx-auto px-4 text-center">
        <motion.h2 
          ...
          viewport={{ once: true }}
          data-testid="text-million-users"
        >
          1 million users,<br />
          plus you.
        </motion.h2>
        <motion.p 
          ...
          viewport={{ once: true }}
          data-testid="text-get-started-seconds"
        >
