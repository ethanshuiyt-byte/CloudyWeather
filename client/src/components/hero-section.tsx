      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          >
            <PhoneMockup 
              content={
                <div className="bg-gradient-to-br from-primary to-secondary rounded-[2rem] h-full p-6 text-white">
                  <div className="flex justify-between items-center mb-8">
                    <div className="text-sm opacity-80">20:22</div>
                  ...
                  <div className="space-y-6">
                    <h2 className="text-2xl font-bold">One wallet for all</h2>
                    <p className="text-white/80">Move your money, spend and save money.</p>
